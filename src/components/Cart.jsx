...
export default function Cart() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4">
            <section className="max-w-[400px] w-[95%] bg-white shadow-md p-8 rounded-lg">
                <h2 className="font-extrabold mb-1 text-2xl">My Cart</h2>
                    ...
                    {cart.map(({ productName, productPrice, productImage, quantity }, index) => (
                        <>
                            <section key={productName}>
                                ...
                                <h3><strong className="text-[18px]">Title:</strong> {productName}</h3>

                                <p className="flex items-center gap-3">
                                    <strong className="text-[18px]">Quantity:</strong>
                                ...
                                <p><strong className="text-[18px]">Price:</strong> ${productPrice}</p>
                                <button
                ...
                <hr className="mt-3" />
                <p className="mt-3"><strong className="text-[18px]">Subtotal:</strong> ${totalPrice}</p>
